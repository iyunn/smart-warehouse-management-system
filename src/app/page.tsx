    ...
    <div className="flex h-screen bg-[#080e17] font-sans overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto px-6 py-6 space-y-6">
          {/* Welcome banner */}
          <div className="relative bg-gradient-to-br from-[#0d1f35] to-[#0d1117] border border-cyan-500/10 rounded-2xl px-6 py-5 overflow-hidden">
            ...
            <div className="relative flex items-center justify-between gap-4 flex-wrap">
              <div>
                <h2 className="text-white text-[16px] font-bold">Selamat datang, Admin 👋</h2>
                <p className="text-slate-400 text-[12px] mt-1 max-w-md">
                  Sistem berjalan normal. Terdapat{" "}
                  <span className="text-amber-400 font-semibold">142 aset belum terklasifikasi</span>{" "}
                  yang memerlukan perhatian.
                </p>
              </div>
              <button className="flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-[12px] font-semibold px-4 py-2 rounded-xl hover:from-cyan-400 hover:to-blue-500 transition-all shadow-lg shadow-cyan-500/20 whitespace-nowrap">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            ...
            {/* Mini stats panel */}
            <div className="lg:col-span-2 bg-[#111827] border border-white/[0.06] rounded-2xl p-5 space-y-4">
              <div>
                <h3 className="text-white text-[14px] font-semibold">Distribusi Aset</h3>
                <p className="text-slate-500 text-[11px] mt-0.5">Berdasarkan kategori</p>
              </div>
                  ...
                  return (
                    <div key={item.label}>
                      <div className="flex justify-between items-baseline mb-1.5">
                        ...
                        <span className="text-slate-500 text-[11px]">{item.count.toLocaleString()} <span className="text-slate-700">/ {pct}%</span></span>
                      </div>
              ...
              <div className="pt-2 border-t border-white/[0.06] flex items-center justify-between">
                <span className="text-slate-600 text-[11px]">Total Aset</span>
                <span className="text-white text-[13px] font-bold">3,842</span>
              </div>
            </div>
          </div>
